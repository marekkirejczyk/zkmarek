...
class Layer2(SlideBase):
    ...
    def animate_miniature_final_season(self, scene):
        rectangle = RoundedRectangle(corner_radius=0.1, width = 5, height = 3, color = PRIMARY_COLOR).set_color_by_gradient(PRIMARY_COLOR, HIGHLIGHT2_COLOR).shift(LEFT * 3 + DOWN * 2)
