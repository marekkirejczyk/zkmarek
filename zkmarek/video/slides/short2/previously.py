...
class Previously(SlideBase):
    ...
    def construct(self):
        ...
        self.poly_eval0 = MathTex(r"P(0)=2", color = PRIMARY_COLOR, font_size = 50).next_to(self.vector_values[3], DOWN, buff = 0.2)
    ...
    def animate_in(self, scene):
        ...
        self.polynomial_chart.target.to_edge(DOWN).shift(DOWN*7).scale(0.85)
