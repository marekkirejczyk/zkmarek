...
class TexSlide(SlideBase):
    ...
    def animate_in(self, scene):
        self.new_subsection(
            scene, "deterministic signature", "data/sound/episode2/slide8-0"
        )
        scene.play(Write(self.title_text))
        scene.play(Write(self.tex))
        self.play_sound(scene, "data/sound/episode2/slide8-1")
        self.play_sound(scene, "data/sound/episode2/slide8-2")
        self.play_sound(scene, "data/sound/episode2/slide8-3")
