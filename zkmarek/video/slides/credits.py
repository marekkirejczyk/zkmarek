...
class Credits(SlideBase):
    ...
    def animate_in(self, scene):
        ...
        self.add_credit("Alan Szepieniec @aszepieniec")
        self.add_credit("Piotr Szlachciak @PiotrSzlachciak")
        self.add_credit("Michał Prządka @przadka")
        self.add_title("Music from Blue Dot Sessions")
        self.add_credit("Palms Down - Confectionery")
        self.add_credit("Town Market - Onesuch Village")
        self.add_credit("Plum Blossom - Kokura Station")
        self.add_credit("Our Only Lark - Bitters")
        self.add_credit("Dialtone 11 - Sketchbook 2")
        self.add_credit("Borough - Molerider")
        self.add_credit("License: #2663")
        self.group.generate_target()
        self.group.shift(5 * DOWN)
        self.group.target.shift(17 * UP)
        scene.play(MoveToTarget(self.group, run_time=13, rate_func=rate_functions.linear))
