...
class EthereumBlock(SlideBase):
    ...
    def animate_in(self, scene):
        ...
        self.state_trie.next_to(self.block, DOWN, buff = 0.2).shift(LEFT*2.4)
        ...
        self.rectangle_state_trie.move_to(self.state_trie.get_node(2, 3).get_center()).shift(DOWN*0.2+RIGHT*2.5)
