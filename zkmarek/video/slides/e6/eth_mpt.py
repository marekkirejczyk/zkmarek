from manim import Indicate, Create, UP, LEFT, RIGHT, DOWN, MoveToTarget, Write, Text
...
class ETHPatriciaMerkleTrie(SlideBase):
    ...
    def merkle_particia_trie(self, scene):
        ...
        scene.wait(2)
        scene.play(self.worldState.keys_table.get_rows()[1].animate.set_color(PRIMARY_COLOR).scale(1.5))
        ...
        scene.play(self.worldState.keys_table.get_rows()[2].animate.set_color(SECONDARY_COLOR).scale(1.5))
        scene.play(self.worldState.keys_table.get_rows()[3].animate.set_color(SECONDARY_COLOR).scale(1.5))
        ...
        scene.wait(1)
        scene.play(Indicate(self.MPT.leaf_replace2.field_group[0], color = SECONDARY_COLOR), Indicate(self.worldState.keys_table.get_rows()[0], color = PRIMARY_COLOR, scale_factor=1.5))
        scene.wait(1)
        scene.play(Indicate(self.MPT.leaf_replace2.field_group[1], color = SECONDARY_COLOR), Indicate(self.worldState.values_table.get_rows()[0], color = PRIMARY_COLOR))
