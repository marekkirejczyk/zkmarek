...
class PrimeFields(SlideBase):
    ...
    def animate_sidebar(self, scene):
        ...
        self.new_subsection(scene,
            "Prime fields - class",
            sound="data/sound/episode/s10-8.wav")
        scene.wait(2)
        ...
        self.new_subsection(scene,
            "Prime fields - class",
            sound="data/sound/episode/s10-9.wav")
        ...
        self.new_subsection(scene,
            "Prime fields - class",
            sound="data/sound/episode/s10-10.wav")
        ...
        self.new_subsection(scene,
            "Prime fields - class",
            sound="data/sound/episode/s10-11.wav")
        scene.wait(1)
        for i in range(0, 4):
        ...
        self.new_subsection(scene,
            "Prime fields - class",
            sound="data/sound/episode/s10-12.wav")
        scene.wait(3)
        self.sidebar.indicate_code(scene, "self.value == other.value", run_time=1)

        self.new_subsection(scene,
            "Prime fields - class",
            sound="data/sound/episode/s10-13.wav")
        ...
        self.new_subsection(scene,
            "Prime fields - class",
            sound="data/sound/episode/s10-14.wav")
        scene.wait(1)
