...
class PrimeFields(SlideBase):
    ...
    def animate_pf(self, scene):
        self.new_subsection(scene,
            "Prime fields - clock",
            sound="data/sound/episode/s11-1.wav")
        ...
        self.new_subsection(scene,
            ...
            sound="data/sound/episode/s11-2.wav")
    ...
    def animate_sidebar(self, scene):
        ...
        self.new_subsection(scene,
            "Prime fields - class",
            sound="data/sound/episode/s11-8.wav")
        scene.wait(2)
        ...
        self.new_subsection(scene,
            "Prime fields - class",
            sound="data/sound/episode/s11-9.wav")
        ...
        self.new_subsection(scene,
            "Prime fields - class",
            sound="data/sound/episode/s11-10.wav")
        ...
        self.new_subsection(scene,
            "Prime fields - class",
            sound="data/sound/episode/s11-11.wav")
        scene.wait(1)
        for i in range(0, 4):
        ...
        self.new_subsection(scene,
            "Prime fields - class",
            sound="data/sound/episode/s11-12.wav")
        scene.wait(3)
        self.sidebar.indicate_code(scene, "self.value == other.value", run_time=1)

        self.new_subsection(scene,
            "Prime fields - class",
            sound="data/sound/episode/s11-13.wav")
        ...
        self.new_subsection(scene,
            "Prime fields - class",
            sound="data/sound/episode/s11-14.wav")
        scene.wait(1)
