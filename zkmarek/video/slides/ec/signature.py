from manim import (DOWN, LEFT, RIGHT, UP, Circumscribe, Create, DashedLine,
                   FadeIn, FadeOut, Indicate, MathTex, ReplacementTransform,
...
class Signature(SlideBase):
    ...
    def construct(self):
        ...
        self.sender_label = Text("Signatory", font=PRIMARY_FONT,
            color=PRIMARY_COLOR)
        self.receiver_label = Text("Verifier", font=PRIMARY_FONT,
            color=PRIMARY_COLOR)
    ...
    def animate_in(self, scene):
        ...
        key_box1 = EquationBoxWithIcons.create(
            "⚿", "Private\ key", PRIV_COLOR,
            "⚿", "Public\ key", PUB_COLOR
        ...
        signature = SignatureBoxFront(height=1,
            color=PUB_COLOR).next_to(
        ...
        self.new_subsection(scene, "Signature - secret",
            sound="data/sound/episode1/s27-2.wav")
        ...
        self.new_subsection(scene, "What is signature",
            sound="data/sound/episode1/s27-5.wav")
        scene.wait(3)
        ...
        ver_signature = EquationBoxWithIcons.create(
            "⎘", "r = R_x \mod n", PUB_COLOR,
            "⎘", "s = (msg + r \cdot K_{Priv}) \cdot secret^{-1} \mod n", PUB_COLOR
        ...
        self.new_subsection(scene, "Introduce U1 and U2",
            sound="data/sound/episode1/s27-11.wav")
        ...
        self.new_subsection(scene, "Introduce Q",
            sound="data/sound/episode1/s27-12.wav")
        q_box = EquationBox(
        ...
        self.new_subsection(scene, "Proof",
            sound="data/sound/episode1/s27-13.wav")
        equation = MathTex(
        ...
        self.new_subsection(scene, "Substitute u1 and u2",
            sound="data/sound/episode1/s27-14.m4a")
        ...
        self.new_subsection(scene, "Substitute s",
            sound="data/sound/episode1/s27-14b.wav")
        ...
        equation5 = MathTex(
            ...
            q_box, DOWN, buff=0.5).align_on_border(RIGHT)
        ...
        self.new_subsection(scene, "Cancel secrete with inverse",
            sound="data/sound/episode1/s27-15.wav")
        ...
        self.new_subsection(scene, "Multiply inverse of r",
            sound="data/sound/episode1/s27-15b.m4a")
        ...
        self.new_subsection(scene, "Cancel msg*r^-1 with inverse",
            sound="data/sound/episode1/s27-16.wav")
        ...
        self.new_subsection(scene, "Summary",
            sound="data/sound/episode1/s27-17.wav")
