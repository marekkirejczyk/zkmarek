...
class Signature(SlideBase):
    ...
    def animate_in(self, scene):
        ...
        self.new_subsection(scene, "Signature game",
            sound="data/sound/episode2/s27-1.wav")
        ...
        self.new_subsection(scene, "Signature - secret",
            sound="data/sound/episode2/s27-2.wav")
        ...
        self.new_subsection(scene, "What is signature",
            sound="data/sound/episode2/s27-5.wav")
        scene.wait(3)
        ...
        self.new_subsection(scene, "Introduce U1 and U2",
            sound="data/sound/episode2/s27-11.wav")
        ...
        self.new_subsection(scene, "Introduce Q",
            sound="data/sound/episode2/s27-12.wav")
        q_box = EquationBox(
        ...
        self.new_subsection(scene, "Proof",
            sound="data/sound/episode2/s27-13.wav")
        equation = MathTex(
        ...
        self.new_subsection(scene, "Substitute u1 and u2",
            sound="data/sound/episode2/s27-14.m4a")
        ...
        self.new_subsection(scene, "Substitute s",
            sound="data/sound/episode2/s27-14b.wav")
        ...
        self.new_subsection(scene, "Cancel secrete with inverse",
            sound="data/sound/episode2/s27-15.wav")
        ...
        self.new_subsection(scene, "Multiply inverse of r",
            sound="data/sound/episode2/s27-15b.m4a")
        ...
        self.new_subsection(scene, "Summary",
            sound="data/sound/episode2/s27-17.wav")
