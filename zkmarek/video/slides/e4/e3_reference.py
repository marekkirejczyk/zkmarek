...
class Episode3Reference(SlideBase):
    ...
    def animate_in(self, scene):
        ...
        scene.wait(1)
        scene.play(TransformMatchingShapes(VGroup(self.bilinearity2[2].copy(), self.bilinearity2[4].copy(), self.bilinearity2[11].copy(), self.bilinearity2[13].copy()) ,self.bilinearity3))
        scene.wait(1)
