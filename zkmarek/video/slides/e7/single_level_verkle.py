...
class SingleLevelVerkleTree(SlideBase):
    ...
    def construct(self):
        ...
        self.opening = MathTex(r"{{a_{15} }} = 85", color = PRIMARY_COLOR, font_size = 40).next_to(self.proof, DOWN, buff = 0.3)
        self.opening2 = MathTex(r"{{a_{2047} }} = 85", color = PRIMARY_COLOR, font_size = 40).next_to(self.verifier, DOWN, buff = 1.0)
        self.opening3 = MathTex(r"{{a_{255} }} = 85", color = PRIMARY_COLOR, font_size = 40).next_to(self.verifier, DOWN, buff = 1.0)
