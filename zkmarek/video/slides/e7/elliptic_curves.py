...
class EllipticCurves(SlideBase):
    ...
    def construct(self):
        ...
        self.p = (
            ...
            .next_to(self.chart_ec, LEFT, buff=1.5)
            .shift(UP * 0.2)
        )
        self.r = (
        ...
        self.sim_32 = MathTex(r"\sim", color=HIGHLIGHT_COLOR, font_size=32).next_to(
            self.bytes_of_el, LEFT, buff=0.1
        )
        self.curve_ec = Text(
            "BLS12-381", color=HIGHLIGHT_COLOR, font=PRIMARY_FONT, font_size=34
        ).next_to(self.chart_ec, RIGHT, buff=0.3)
        ...
        self.point_to_generator_label = MathTex(
            r"{{G \cdot 1}}", color=SECONDARY_COLOR, font_size=32
        ).next_to(self.point_to_generator, RIGHT, buff=0.5)

        self.dot_48b = self.chart_ec.get_point(FieldElement(7, 137))
    ...
    def animate_in(self, scene):
        ...
        scene.play(
            FadeOut(self.chart_ec_continuous), FadeIn(self.chart_ec), run_time=0.5
        )
        ...
        self.point_to_generator_label2 = MathTex(
            r"{{G_2 \cdot 1}}", color=PRIMARY_COLOR, font_size=32
        ...
        scene.play(FadeOut(self.chart_scalar), FadeIn(self.chart_scalar_Fq), run_time=1)
        scene.wait(2.5)
