...
#             r"Pairing", font_size=50, color=PRIMARY_COLOR, font=PRIMARY_FONT
#         )
...
#             r"Subgroup of points on elliptic curve",
#             font_size=30,
#             color=PRIMARY_COLOR,
#             font=PRIMARY_FONT,
#         )
...
#         )
#         self.brace2.put_at_tip(self.brace2_label)
#         self.brace3_label = Text(
#             r"Prime field", font_size=30, color=PRIMARY_COLOR, font=PRIMARY_FONT
#         )
#         self.brace3.put_at_tip(self.brace3_label)

#         self.bilinearity_label = Text(
#             r"Bilinearity", font_size=40, color=SECONDARY_COLOR, font=PRIMARY_FONT
#         )
...
#         self.non_degeneracy_label = Text(
#             r"Non-degeneracy", font_size=40, color=SECONDARY_COLOR, font=PRIMARY_FONT
#         )
#         nd_text = r"\forall{a \in G_1}, \forall{b \in G_2} (a, b \neq \mathcal{O}"
#         nd_text += r" \Rightarrow e(a, b) \neq 1_{G_T}) "
#         self.non_degeneracy = MathTex(nd_text, font_size=40, color=SECONDARY_COLOR)
#         self.computability_label = Text(
#             r"Computability", font_size=40, color=SECONDARY_COLOR, font=PRIMARY_FONT
#         )
...
#     def animate_in(self, scene):
#         self.new_subsection(
#             scene, "what is a pairing", "data/sound/episode3/slide3-0.mp3"
#         )
#         scene.play(Write(self.definition_label))
#         scene.play(Write(self.definition))
...
#         self.new_subsection(
#             scene, "bilinearity example", "data/sound/episode3/slide3-1.mp3"
#         )
#         self.example_bilinearity(scene)
#         self.new_subsection(
#             scene, "finishing example", "data/sound/episode3/slide3-2.mp3"
#         )
#         self.new_subsection(scene, "multiplying", "data/sound/episode3/slide3-3.mp3")
#         # self.bilinearity_morph.animate_in(scene)
#         scene.play(Unwrite(self.bilinearity))
#         self.new_subsection(
#             scene, "explaining the multiplying", "data/sound/episode3/slide3-4.mp3"
#         )
#         scene.play(
...
#         self.new_subsection(scene, "non degeneracy", "data/sound/episode3/slide3-5.mp3")
#         scene.play(Write(self.non_degeneracy_label))
#         scene.play(Write(self.non_degeneracy))
#         self.new_subsection(scene, "computability", "data/sound/episode3/slide3-6.mp3")
#         scene.play(Write(self.computability_label))

#     def example_bilinearity(self, scene):
#         other_things = VGroup(self.bilinearity, self.bilinearity_label, self.definition)
#         other_things.generate_target()
#         other_things.target.to_edge(LEFT)
#         scene.play(MoveToTarget(other_things))
...
#         self.bilinearity.generate_target()
#         self.bilinearity_label.generate_target()
#         self.definition.generate_target()
#         self.bilinearity.target.get_center()
#         self.bilinearity_label.target.get_center()
#         self.definition.target.get_center()
#         scene.play(
#             MoveToTarget(self.bilinearity),
#             MoveToTarget(self.bilinearity_label),
#             MoveToTarget(self.definition),
#         )