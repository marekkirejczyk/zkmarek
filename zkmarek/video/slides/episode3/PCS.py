...
from zkmarek.video.constant import PRIMARY_COLOR, HIGHLIGHT_COLOR
...
class PolynomialCommitment(SlideBase):
    ...
    def construct(self):
        ...
        self.polynomial2 = MathTex(
            r"p(x) = p_n x^n + \cdots + p_1 x + p_0", color=PRIMARY_COLOR
        ).scale(0.9)
    ...
    def animate_in(self, scene):
        ...
        self.polynomial2.target.next_to(self.chart, RIGHT)
        scene.play(MoveToTarget(self.polynomial2))
        scene.wait(9)
