...
from src.point_on_curve import PointOnCurve
from manim import *
...
class EllipticCurves(Scene):
    ...
    def operations(self, group, ax):
        ...
        self.play(FadeOut(sidebar), FadeOut(p1), Wait())
